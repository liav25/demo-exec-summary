...
class PDFGenerator:
    ...
    def _get_pdf_css(self) -> str:
        """Get CSS optimized for PDF generation with professional design palette"""
        return """
        ...
        .header::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--primary-blue) 0%, var(--accent-purple) 50%, var(--accent-teal) 100%);
        }
